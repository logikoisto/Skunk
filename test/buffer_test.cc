...
TEST(BufferTest, ReadWritePrimitives){
  ...
  char cStr[] = {0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x10};
  ...
  ASSERT_EQ(buffer.Writeable(), 0); //FIXME: if expand at low water mark so this will be 32 double expand 
...
TEST(BufferTest, WriteWithExpand){
  ...
  char segmentExpandTwo[16] = {0x30, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37, 0x38, 0x39, 0x3a, 0x3b, 0x3c, 0x3d, 0x3e, 0x40};
